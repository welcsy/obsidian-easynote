...
export const TRANSLATIONS: Record<string, { zh: string; en: string }> = {
    ...
    'settings.toolbarLayout':              { zh: '工具列排列', en: 'Toolbar Layout' },
    'settings.toolbarLayout.desc':         { zh: '選擇工具列顯示模式：完全顯示所有工具群組，或精簡只顯示指定的捷徑按鈕。', en: 'Choose toolbar display mode: Full shows all tool groups, Compact shows only specified shortcut buttons.' },
    'settings.toolbarLayout.full':         { zh: '完全', en: 'Full' },
    'settings.toolbarLayout.compact':      { zh: '精簡', en: 'Compact' },
    'settings.toolbarShortcuts':           { zh: '精簡模式捷徑', en: 'Compact Shortcuts' },
    'settings.toolbarShortcuts.desc':      { zh: '選擇最多 8 個快捷工具在精簡模式下顯示。', en: 'Choose up to 8 shortcut tools to show in compact mode.' },
    'settings.toolbarShortcuts.slot':      { zh: '捷徑', en: 'Slot' },
    'settings.shortcut.none':              { zh: '（無）', en: '(None)' },
    'settings.shortcut.eraser':            { zh: '橡皮擦', en: 'Eraser' },
    'settings.shortcut.paintselect':       { zh: '繪畫選取', en: 'Paint Select' },
    'settings.shortcut.colors':            { zh: '顏色選擇器', en: 'Color Picker' },
    'settings.shortcut.text':              { zh: '文字工具', en: 'Text Tool' },
    'settings.shortcut.fontSize':          { zh: '文字大小', en: 'Font Size' },
    'settings.shortcut.textColor':         { zh: '文字顏色', en: 'Text Color' },
    'settings.shortcut.select':            { zh: '圈選工具', en: 'Select Tool' },
    'settings.shortcut.loadLocal':         { zh: '載入本機圖片', en: 'Load Local Image' },
    'settings.shortcut.loadVault':         { zh: '載入庫圖片', en: 'Load Vault Image' },
    'settings.shortcut.loadNote':          { zh: '載入筆記', en: 'Load Note' },
    'settings.shortcut.undo':              { zh: '上一步', en: 'Undo' },
    'settings.shortcut.redo':              { zh: '下一步', en: 'Redo' },
    'settings.shortcut.brushSize':         { zh: '筆刷大小', en: 'Brush Size' },
    'settings.shortcut.brushOpacity':      { zh: '筆刷透明度', en: 'Brush Opacity' },
    'settings.shortcut.pan':               { zh: '平移工具', en: 'Pan Tool' },
    'settings.shortcut.newCanvas':         { zh: '新畫布', en: 'New Canvas' },
    'settings.shortcut.canvasSize':        { zh: '畫布大小', en: 'Canvas Size' },
    'settings.shortcut.saveProject':       { zh: '儲存畫布', en: 'Save Project' },
